...
app.use(cors({
  origin: ['http://localhost:5000', 'http://localhost:5173', 'http://localhost:5174', 'http://localhost:3000', 'https://feemanagment-full-frontend-backup.onrender.com' , 'https://feesmanagement-frontend.onrender.com'],
  credentials: true
}));
